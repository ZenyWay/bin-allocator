...
[bin-allocator Gitter channel](https://gitter.im/ZenyWay/bin-allocator).

## <a name="issues"></a> Issues
### Security issues
For the security of the community relying on bin-allocator,
...
are tracked as GitHub [issues in this repository](https://github.com/ZenyWay/bin-allocator/issues):
* please either [submit a new issue](https://github.com/ZenyWay/bin-allocator/issues/new)
...
**bin-allocator version:** (only for issues) first version of bin-allocator affected by the issue
...
* a PR must close at least one [open issue](https://github.com/ZenyWay/bin-allocatorg/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen).
The corresponding issues should be listed in the title of the PR,
e.g. "close #21, #42".
* all PRs must pass the full bin-allocator test suite and
...
https://github.com/ZenyWay/bin-allocator/blob/master/ICLA.
```
This is required both in the contributor's own interest,
and that of the community relying on this project,
...
#### CI
CI testing runs on [TravisCI](https://travis-ci.org/ZenyWay/bin-allocator).
